...
import familyjson from "./jsonfile.json"
...
class familySurvey extends Component {
  ...
  savePDF = model => {
    var surveyPDF = new SurveyPDF.SurveyPDF(familyjson);
    surveyPDF.data = model.data;
    surveyPDF.save();
  };

  render() {
    var model = new Survey.Model(familyjson);
    return (
      <div className="App">
         <div className="App-header">
         <Link to="/">
                <img src={logo} className="App-logo" alt="logo" /></Link>
         <h2>البحث الوطني حول الأسرة</h2>
          <h2>            2020          </h2>
